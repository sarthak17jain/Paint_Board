...
let optionsCont = document.querySelector(".hamburger-menu");
...
// true -> to show the tools, false-> hide tools
optionsCont.addEventListener("click",(e)=>{
    optionsFlag = !optionsFlag;
    optionsFlag == true ? openTools() : closeTools();
});
...
function createSticky(stickyTemplateHTML){
    ...
    noteAction(minimise,remove,stickyCont);
...
function noteAction(minimise, remove, stickyCont){
